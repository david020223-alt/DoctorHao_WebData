...
## design-v1.6.0 — 2026-09-16

- 52 篇文章的互動 3D 區塊改為白底 2D 向量示意，圖下直接顯示三項文字附註，並提供附註版 SVG 下載。
- 圖解索引改用 2D 縮圖與下載；停用舊版立體封面備援。
- 六張內文示意圖改為平面風格；自動檢查流程改驗證 2D 素材，避免重新產生舊版模型。

## design-v1.5.1 — 2026-09-16

- 首頁瀏覽人次移至頁尾最底部，以與版權資訊一致的小字單行顯示，移除獨立大區塊。

## design-v1.5.0 — 2026-09-15

- 頁首導覽列新增 Threads 圖示連結，連至既有的 @drchenghao 帳號，桌機與手機頂部皆可直接開啟。
- 手機選單另提供具帳號文字的 Threads 連結，並調整小螢幕頁首間距。
- 首頁門診資訊下方新增網站瀏覽人次，從功能上線起累計全站可見頁面的載入次數，並顯示起算日期。
- 使用 Workers Free 支援的 SQLite Durable Object 原子累加，重新發布保留數值；排除已知爬蟲及跨站送出的計數請求，僅儲存總數與起算日期。
